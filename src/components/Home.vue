       ...
       <!-- Navigation -->
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <router-link to="/dashboard" class="navbar-brand" > Vegas Coin </router-link>
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <router-link to="/launcher"> <i class="fa fa-rocket fa-fw"></i> Launcher </router-link>
                        </li>
                        <li>
                        ...
                        <li>
                            <router-link to="/tables">  <i class="fa fa-table fa-fw"></i> Tables </router-link>
                        </li>
                        <li>
                            <router-link to="/forms">  <i class="fa fa-table fa-fw"></i> Forms </router-link>
                        </li>
                        <li>
